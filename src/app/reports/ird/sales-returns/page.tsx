...
export default async function IrdSalesReturnsPage() {
  ...
  return (
    <Card>
      <SectionTitle
        icon={Undo2}
        title="Sales Return Register (बिक्री फिर्ता खाता)"
        subtitle="Statutory credit notes issued for customer billing adjustments and meter corrections"
      />
      <IrdReturnsView defaultTab="SALES_RETURN" />
    </Card>
  );
}
