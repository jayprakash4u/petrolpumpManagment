...
import { VatSplitView } from "@/components/auditor/VatSplitView";

export default async function VatSplitPage() {
    ...
    return (
      <Card className="mx-auto max-w-md text-center py-10">
        ...
        <p className="mt-1.5 text-[13.5px] text-text-muted">
          VAT taxable vs exempt reports are restricted to station owners and managers.
        </p>
      </Card>
    );
  }
