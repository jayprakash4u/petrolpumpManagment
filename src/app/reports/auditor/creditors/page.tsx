...
import { CreditorAgeingView } from "@/components/auditor/CreditorAgeingView";

export default async function CreditorAgeingPage() {
    ...
    return (
      <Card className="mx-auto max-w-md text-center py-10">
        ...
        <p className="mt-1.5 text-[13.5px] text-text-muted">
          Creditor ageing reports are restricted to station owners and managers.
        </p>
      </Card>
    );
  }
