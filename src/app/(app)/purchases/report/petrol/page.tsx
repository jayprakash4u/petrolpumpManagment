...
import { PetrolPurchaseReportView } from "@/components/purchases/PetrolPurchaseReportView";

export default async function PetrolPurchaseReportPage() {
