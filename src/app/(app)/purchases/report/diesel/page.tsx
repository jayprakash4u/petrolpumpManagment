...
export default async function DieselPurchaseReportPage({ searchParams }: PageProps<"/purchases/report/diesel">) {
  ...
  const filters = parsePurchaseRegisterFilters(params, "DIESEL");
  ...
  return (
    <div>
      ...
      <Card>
        <SectionTitle icon={Fuel} title="Diesel Purchase Report" subtitle="Diesel bills only — subtotal, VAT, and landed total" />
