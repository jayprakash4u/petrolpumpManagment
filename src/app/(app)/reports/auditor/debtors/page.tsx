...
import { DebtorAgeingView } from "@/components/auditor/DebtorAgeingView";

export default async function DebtorAgeingPage() {
    ...
    return (
      <Card className="mx-auto max-w-md text-center py-10">
        ...
        <p className="mt-1.5 text-[13.5px] text-text-muted">
          Debtor ageing reports are restricted to station owners and managers.
        </p>
      </Card>
    );
  }
