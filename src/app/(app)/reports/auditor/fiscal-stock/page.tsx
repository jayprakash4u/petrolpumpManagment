...
import { FiscalStockView } from "@/components/auditor/FiscalStockView";

export default async function FiscalStockPage() {
    ...
    return (
      <Card className="mx-auto max-w-md text-center py-10">
        ...
        <p className="mt-1.5 text-[13.5px] text-text-muted">
          Fiscal year stock valuation reports are restricted to station owners and managers.
        </p>
      </Card>
    );
  }
