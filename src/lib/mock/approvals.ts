...
export const MOCK_APPROVAL_RULES: ApprovalRule[] = [
  {
    ...
    presenterRoles: ["MANAGER", "CASHIER", "ATTENDANT"],
  ...
  },
  {
    ...
    presenterRoles: ["MANAGER", "CASHIER"],
    approverRoles: ["OWNER", "MANAGER"],
  ...
  },
  {
    ...
    presenterRoles: ["ATTENDANT", "CASHIER"],
    approverRoles: ["OWNER", "MANAGER"],
    minAmountForApprovalNpr: 0,
    requireDualApproval: false,
  ...
  },
  {
    ...
    presenterRoles: ["CASHIER", "ATTENDANT"],
    approverRoles: ["OWNER", "MANAGER"],
