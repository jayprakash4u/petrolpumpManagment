...
export interface PermissionDefinition {
  key: Permission;
  name: string;
  category: "Sales & Cash" | "Stock & Pricing" | "Customers & Credit" | "Operations & Admin";
  description: string;
  sidebarMenu: string;
}
...
export const STATION_ROLES: RoleInfo[] = [
  {
    ...
    badgeTone: "accent",
    summary: "Complete authority over station financials, rates, employee accounts, and system configuration.",
    responsibilities: [
      "Add, deactivate, and manage employee accounts",
      "Update fuel rates and tank master configurations",
      "Review financial statements, audit trail, and profit & loss",
      "Authorize high-value expense vouchers and stock write-offs",
    ],
    staffCount: 1,
  },
  {
    ...
    badgeTone: "accent",
    summary: "Oversees daily operations, stock deliveries, dispenser pricing, credit customers, and reports.",
    responsibilities: [
      "Record tanker fuel deliveries and supplier purchases",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Redeem customer fuel coupon leaves",
    ],
    staffCount: 3,
  },
  {
    ...
    name: "Pump Attendant",
    badgeTone: "muted",
    summary: "Dispenses fuel at the nozzles, records walk-in transactions, and manages own shift counter.",
    responsibilities: [
      "Start and close assigned nozzle shift meter readings",
      "Dispense petrol, diesel, or CNG to vehicles",
      "Issue cash sale receipts to drivers",
    ],
    staffCount: 8,
  },
];
...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  {
    key: "manageUsers",
    name: "Manage Employees & System Access",
    category: "Operations & Admin",
    description: "Create employee login accounts, change roles, deactivate staff, and configure permissions.",
