...
const APPROVAL_TABS = [
  { href: "/approvals", label: "Pending Queue & Overview", icon: Inbox },
  { href: "/approvals/submit", label: "Submit Request", icon: PlusCircle },
  { href: "/approvals/rules", label: "Policy & Authority Rules", icon: ShieldAlert },
  { href: "/approvals/history", label: "Audit History", icon: History },
];
