...
export interface DieselPriceRule {
  id: string;
  sn: number;
  customerName: string;
  pan: string;
...
const INITIAL_DIESEL_PRICES: DieselPriceRule[] = [
  {
    id: "dp-0",
    sn: 1,
  ...
  },
  {
    id: "dp-1",
    sn: 2,
    customerName: "Kathmandu Valley Transport Pvt. Ltd.",
    pan: "600123456",
    ...
    remarks: "High-volume commercial fleet discount (Rs. 2 off)",
  },
  {
    id: "dp-2",
    sn: 3,
    ...
    rateType: "Contracted Discount",
    basePrice: 165.0,
    discountPerLitre: 3.0,
    finalPrice: 162.0,
    effectiveDateBS: "2083/03/01",
    remarks: "Bulk construction supply agreement",
  },
  {
    id: "dp-3",
    sn: 4,
    customerName: "Sagarmatha Logistics & Freight",
    pan: "600987654",
    rateType: "Contracted Discount",
    basePrice: 165.0,
    ...
    remarks: "Long-haul freight carrier",
  },
];

export function DieselPricesView() {
  const [prices, setPrices] = useState<DieselPriceRule[]>(INITIAL_DIESEL_PRICES);
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/80 pb-3">
        <div>
          <h1 className="font-display text-xl font-bold tracking-tight text-text sm:text-2xl flex items-center gap-2">
            ...
            <span>Diesel (HSD) Prices Matrix</span>
          </h1>
          <p className="text-[12px] text-text-muted mt-0.5">
            Standard station retail rates and customized party pricing agreements for High Speed Diesel (HSD).
          </p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-surface shadow-xs p-4 sm:p-5 space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-1.5">
            <GhostButton type="button" onClick={() => showToast("Copied Diesel prices!")} className="h-8 px-2.5 text-xs font-semibold gap-1">
              <Copy size={13} />
              <span>Copy</span>
            </GhostButton>
          ...
          <div className="relative w-48 sm:w-64">
            ...
            <input
              type="text"
              placeholder="Search diesel price rules..."
              value={searchQuery}
