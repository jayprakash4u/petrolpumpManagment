...
const STORAGE_KEY_DIESEL = "fsm_diesel_stock_ledger_records";
const STORAGE_KEY_PETROL = "fsm_petrol_stock_ledger_records";

const INITIAL_DIESEL_LEDGER_ENTRIES: StockLedgerEntry[] = [
  {
    id: "dsl-open",
    dateBS: "",
  ...
  },
  {
    ...
    sn: 2,
    dateBS: "2083.05.18",
    particulars: "binaei construction broom udayog and suppliers pvt ltd 10-4147-083/084",
    inQty: 0,
    outQty: 129.8,
  },
  {
    ...
    sn: 3,
    dateBS: "2083.05.18",
    particulars: "CASH 10-4148-083/084",
    inQty: 0,
    outQty: 4.0,
  },
  {
    ...
    sn: 4,
    dateBS: "2083.05.18",
    particulars: "Madhavi College PVT LTD. 10-4149-083/084",
    inQty: 0,
    outQty: 40.0,
  },
  {
    ...
    sn: 5,
    dateBS: "2083.05.18",
    particulars: "Namaste Creation And Advertising PVT. LTD 10-4150-083/084",
    inQty: 0,
    outQty: 70.0,
  },
  {
    ...
    sn: 6,
    dateBS: "2083.05.18",
    particulars: "Nano Academy PVT. LTD. 10-4151-083/084",
    inQty: 0,
    outQty: 70.0,
  },
  {
    ...
    sn: 7,
    dateBS: "2083.05.18",
    particulars: "CASH 10-4204-083/084",
    inQty: 0,
    outQty: 20.0,
  },
  {
    ...
    sn: 8,
    dateBS: "2083.05.18",
    particulars: "classic boutique hotel PVT. LTD. 10-4214-083/084",
    inQty: 0,
    outQty: 400.0,
  },
  {
    ...
    sn: 9,
    dateBS: "2083.05.18",
    particulars: "CASH 10-4215-083/084",
    inQty: 0,
    outQty: 25.0,
  },
  {
    ...
    sn: 10,
    dateBS: "2083.05.18",
    particulars: "CASH 10-4224-083/084",
    inQty: 0,
    outQty: 25.0,
  },
  {
    ...
    sn: 11,
    dateBS: "2083.05.18",
    particulars: "BISHNU MEMORIAL BOARDING SCHOOL PVT.LTD. 10-4226-083/084",
    inQty: 0,
    outQty: 51.0,
  },
  {
    ...
    sn: 12,
    dateBS: "2083.05.19",
    particulars: "amrit-eps 200460 1934",
    inQty: 0,
    outQty: 18.041,
  },
  {
    ...
    sn: 13,
    dateBS: "2083.05.19",
    particulars: "CASH 10-4251-083/084",
    inQty: 0,
    outQty: 24.0,
  },
  {
    ...
    sn: 14,
    dateBS: "2083.05.19",
    particulars: "CASH 10-4252-083/084",
    inQty: 0,
    outQty: 26.0,
  },
  {
    ...
    sn: 15,
    dateBS: "2083.05.19",
    particulars: "CASH 10-4253-083/084",
    inQty: 0,
    outQty: 41.6,
  },
  {
    ...
    sn: 16,
    dateBS: "2083.05.19",
    particulars: "CASH 10-4254-083/084",
    inQty: 0,
    outQty: 38.707,
  },
  {
    ...
    sn: 17,
    dateBS: "2083.05.19",
    particulars: "CASH 10-4255-083/084",
    inQty: 0,
    outQty: 5.0,
  },
  {
    ...
    sn: 18,
    dateBS: "2083.05.19",
    particulars: "CASH 10-4257-083/084",
    inQty: 0,
    outQty: 15.0,
  },
  {
    ...
    sn: 19,
    dateBS: "2083.05.19",
    particulars: "Gorkha Construction Co. Nepal Pvt LTD. 10-4266-083/084",
    inQty: 0,
    outQty: 38.0,
  },
  {
    ...
    sn: 20,
    dateBS: "2083.05.19",
    particulars: "KATHMANDU SHIV SHALAYA PVT.LTD. 10-4272-083/084",
    inQty: 0,
    outQty: 20.0,
  },
];

const INITIAL_PETROL_LEDGER_ENTRIES: StockLedgerEntry[] = [
  {
    id: "ptl-open",
    dateBS: "",
    particulars: "Opening Stock",
  ...
  },
  {
    ...
    sn: 1,
    dateBS: "2083.05.18",
    particulars: "NOC 20009818 (Nepal Oil Corporation)",
    inQty: 4000.0,
    outQty: 0,
  },
  {
...
interface DieselStockLedgerViewProps {
  fuelName?: string;
  stationName?: string;
  stationAddress?: string;
}

export function DieselStockLedgerView({
  fuelName = "Diesel",
  stationName = "Nepal Petroleum",
  stationAddress = "New Baneshwor-31, Kathmandu",
}: DieselStockLedgerViewProps) {
  const isPetrol = fuelName.toLowerCase().includes("petrol");
  const storageKey = isPetrol ? STORAGE_KEY_PETROL : STORAGE_KEY_DIESEL;
  const initialData = isPetrol ? INITIAL_PETROL_LEDGER_ENTRIES : INITIAL_DIESEL_LEDGER_ENTRIES;
  ...
  // Date filters matching reference
  ...
  // Compute running balance exactly as on screenshot
  const computedRows = useMemo(() => {
    let runningBalance = 0;
    return filteredEntries.map((item, idx) => {
      if (item.isOpening) {
  ...
  // Total summary calculations matching screenshot
  ...
  const handleDownloadExcel = () => {
    ...
    const csvContent = [
      `"${stationName}"`,
      `"${stationAddress}"`,
      `"${fuelName} Stock Ledger (${activeDateRange.from} to ${activeDateRange.to})"`,
      "",
      headers.join(","),
    ...
    link.href = url;
    link.download = `${fuelName.toLowerCase()}_stock_ledger_${activeDateRange.from}_${activeDateRange.to}.csv`;
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/80 pb-3 print:hidden">
        <div>
          <h1 className="font-display text-xl font-bold tracking-tight text-text sm:text-2xl flex items-center gap-2">
            ...
            <span>Stock Ledger ({fuelName})</span>
          </h1>
